...
export default class Base extends PureComponent {
  ...
  constructor(props) {
    ...
    this.items = [
      {label: Languages.news, icon: 'home', onPress: () => this.goToScreen('home')},
      {label: Languages.contact, icon: 'mail', onPress: this.goToContact},
      {label: Languages.aboutus, icon: 'assignment', onPress: this.goToAbout},
      {label: Languages.setting, icon: 'settings', onPress: () => this.goToScreen('setting')},
      {
        label: Languages.user, icon: 'User', onPress: () => {
  ...
  goToContact = () => {
    this.goToScreen('customPage', {id: Config.CustomPages.contact_id, title: Languages.contact});
  }

  goToAbout = () => {
    this.goToScreen('customPage', {id: Config.CustomPages.aboutus_id, title: Languages.aboutus});
